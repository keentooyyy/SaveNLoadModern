    ...
    <form @submit.prevent>
      ...
      <div class="mb-3">
        <div class="form-check">
          <input class="form-check-input bg-primary border-secondary" type="checkbox" id="rememberMe" />
          <label class="form-check-label text-white fs-6" for="rememberMe">Remember Me</label>
        </div>
      </div>
      <div class="d-grid">
        <button type="submit" class="btn btn-secondary text-white fw-bold mt-3 py-2">LOGIN</button>
      </div>
