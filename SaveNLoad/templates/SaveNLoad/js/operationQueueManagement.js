...
(function () {
    ...
    function loadStats() {
        ...
        if (!url) {
            // Use clearElement from gameFormUtils.js since this is admin page
            if (typeof window.clearElement === 'function') {
                window.clearElement(statsContainer);
            } else {
