from SaveNLoad.views import auth  # noqa: F401
...
from SaveNLoad.views import client_worker_api  # noqa: F401

__all__ = ['auth', 'dashboard', 'custom_decorators', 'rawg_api', 'settings', 'save_load_api', 'client_worker_api']
